...
projDS <- fread('C:/Users//m039388/Desktop/583/trainsample.csv', stringsAsFactors = F, nrows=numberRows)
summary(projDS)
...
projDS$hour <- factor(projDS$hour)
projDS$minute <- factor(projDS$minute)
